...
import ReactQueryErrorHandler from "../../components/ReactQueryErrorHandler";
import { useAppointmentList } from '../../hooks/useAppointmentList';

const MyAppointments = () => {
  const [currentPage, setCurrentPage] = useState(1);
  const { data, error, isLoading, isError } = useAppointmentList(currentPage);
  ...
  return (
    <div className="w-full h-screen flex">
      ...
      <div className="flex-1 flex flex-col">
        <Navbar />
        {isError ? (
          <ReactQueryErrorHandler error={error.message} />
        ) : (
            ...
            <div className="w-full overflow-hidden ">
              <div className="w-full h-[30%]  ">
                ...
                <table className="table-auto w-full ">
                  ...
                  <tbody>
                    {data?.myAppointments?.map((data, index) => (
